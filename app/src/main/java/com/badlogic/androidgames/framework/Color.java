...
public class Color {
    ...
    public static final int MAGENTA = 0xffff00ff; // mandatory debug color lol

    // FIXME: let's keep just some utility colors, all the other should be declared in their respective class where they are used
