...
public class ContactManager {
  ...
  public void setBroadPhase(SWIGTYPE_p_b2BroadPhase value) {
    liquidfunJNI.ContactManager_broadPhase_set(swigCPtr, this, SWIGTYPE_p_b2BroadPhase.getCPtr(value));
  }

  public SWIGTYPE_p_b2BroadPhase getBroadPhase() {
    return new SWIGTYPE_p_b2BroadPhase(liquidfunJNI.ContactManager_broadPhase_get(swigCPtr, this), false);
  }
  ...
  public void setAllocator(SWIGTYPE_p_b2BlockAllocator value) {
    liquidfunJNI.ContactManager_allocator_set(swigCPtr, this, SWIGTYPE_p_b2BlockAllocator.getCPtr(value));
  }

  public SWIGTYPE_p_b2BlockAllocator getAllocator() {
    long cPtr = liquidfunJNI.ContactManager_allocator_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_b2BlockAllocator(cPtr, false);
  }
