...
public class ParticleColor {
  ...
  protected static long swigRelease(ParticleColor obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public ParticleColor(SWIGTYPE_p_b2Color color) {
    this(liquidfunJNI.new_ParticleColor__SWIG_2(SWIGTYPE_p_b2Color.getCPtr(color)), true);
  }
  ...
  public void set(SWIGTYPE_p_b2Color color) {
    liquidfunJNI.ParticleColor_set__SWIG_1(swigCPtr, this, SWIGTYPE_p_b2Color.getCPtr(color));
  }
